...
Helen implemented the three baselines (BOP, IPCP, Berti). Jerry set up
OpenEvolve and ran the single-trace evolutions. Hao ran the multi-trace
evolution. All three discussed and reviewed this writeup.
